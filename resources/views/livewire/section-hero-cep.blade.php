        ...
        <div class="flex flex-col items-start gap-10 lg:flex-row lg:items-center lg:gap-16">
            ...
            <div class="flex-1">
                ...
                <h1 class="font-mono text-4xl font-bold leading-tight tracking-tight text-background md:text-5xl lg:text-6xl" style="text-wrap: balance;">
                    {!! str_replace('agilidade', '<span class="text-primary">agilidade</span>', data_get($mainSlide, 'title', 'Concreto usinado com <span class="text-primary">agilidade</span> e precisao no traco')) !!}
                </h1>

                <p class="mt-6 max-w-xl text-lg leading-relaxed text-background/60">
                    {{ data_get($mainSlide, 'subtitle', 'Entrega rapida, rastreamento em tempo real e suporte tecnico especializado para garantir o sucesso da sua obra do inicio ao fim.') }}
                </p>
                ...
                <div class="rounded-xl border border-background/10 bg-background/5 p-8 backdrop-blur-sm">
                    ...
                    <div id="hero-cep-success">
                        ...
                        <div class="mt-4 flex flex-col gap-3">
                            <a id="hero-whatsapp-link" href="https://wa.me/5511999999999?text=Ol%C3%A1!%20Verifiquei%20que%20voc%C3%AAs%20atendem%20minha%20regi%C3%A3o%20({{ $cep }}).%20Preciso%20de%20concreto%20usinado%20para%20minha%20obra." target="_blank" rel="noopener noreferrer"
