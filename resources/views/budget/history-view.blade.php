        ...
        <div
            ...
            <div class="rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <h2 class="text-base font-semibold flex flex-initial gap-2 leading-6 text-gray-950 dark:text-white">
                        <span>

                            @if($budget->action === 'update')
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="h-6 w-6 mr-4">
                ...
                <p
                    ...
                    {{ $budget->user->name }} has {{ $budget->action === 'update' ? 'updated' : 'created'
                    }} {{ ' this budget on ' . $budget->created_at->format('d/m/Y H:i') }}</p>
            </div>
        </div>
