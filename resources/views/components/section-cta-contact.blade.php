        ...
        <div class="relative overflow-hidden rounded-3xl bg-card border border-border p-8 md:p-12">
            ...
            <div class="relative flex flex-col items-center justify-between gap-8 lg:flex-row">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="{{ $whatsapp }}" target="_blank" class="inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-6 py-4 font-bold text-white transition-all hover:scale-105 hover:shadow-lg">
                        <i data-lucide="message-circle" class="h-5 w-5"></i>
                        WhatsApp
                    </a>
                    
                    @if($phone)
                        <a href="tel:{{ preg_replace('/\D/', '', $phone) }}" class="inline-flex items-center gap-2 rounded-xl border border-border bg-background/50 px-6 py-4 font-bold text-foreground transition-all hover:bg-border/40 hover:scale-105">
                    ...
                    @if($email)
                        <a href="mailto:{{ $email }}" class="inline-flex items-center gap-2 rounded-xl border border-border bg-background/50 px-6 py-4 font-bold text-foreground transition-all hover:bg-border/40 hover:scale-105">
