<div>
    ...
    <a target="_new"
        ...
        <div style="background-color:{{ $data->whatsapp['color'] ?? ' #25d366'}}"
            class="w-16 h-16  hover:bg-green-500 cursor-pointer fixed z-30  bottom-0 mb-5 mr-5 animate-pulse grid items-center justify-center right-0 text-white text-center rounded-full">
