    ...
    <div class="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div class="lg:col-span-2">
                ...
                <p class="mt-4 max-w-sm text-sm leading-relaxed text-muted-foreground"><?php echo e($websiteDescription); ?> Sua obra merece o melhor desde a fundação.</p>
            </div>
            ...
            <div>
                ...
                <ul class="flex flex-col gap-3 text-sm text-muted-foreground">
                    <li class="flex items-center gap-2"><i data-lucide="phone" class="h-4 w-4 text-primary"></i><?php echo e($companyPhone); ?></li>
                    <li class="flex items-center gap-2"><i data-lucide="mail" class="h-4 w-4 text-primary"></i><?php echo e($companyEmail); ?></li>
                    <li class="flex items-start gap-2"><i data-lucide="map-pin" class="mt-0.5 h-4 w-4 shrink-0 text-primary"></i><?php echo e($companyAddress); ?></li>
                </ul>
            </div>
        </div>

        <div class="mt-12 border-t border-border pt-8 text-center text-xs text-muted-foreground">
            <?php echo e($companyName); ?> &copy; <?php echo e(date('Y')); ?>. Todos os direitos reservados.
        </div>
    </div>
</footer>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($footerScripts): ?>
    <?php echo $footerScripts; ?>

<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH /home/marvincoelho/projects/codhous/resources/views/components/site-footer.blade.php ENDPATH**/ ?>