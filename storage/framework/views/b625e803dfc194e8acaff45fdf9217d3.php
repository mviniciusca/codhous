    ...
    <p class="mt-1 text-[10px] text-background/30 italic">O sistema converte automaticamente para metros.</p>
                ...
                <div class="mt-8 rounded-lg border border-primary/30 bg-primary/10 p-6">
                    ...
                    <div class="mt-2 flex items-baseline gap-2">
                        <span class="font-mono text-4xl font-bold text-primary"><?php echo e(number_format($volume, 2)); ?></span>
                        <span class="text-lg font-medium text-primary/70">m&sup3;</span>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($volume > 0): ?>
                    <p class="mt-2 text-xs text-background/40">
                        Com margem de 10%: <span class="font-semibold text-background/60"><?php echo e(number_format($volumeWithMargin, 2)); ?> m³</span>
                    </p>
...
<?php /**PATH /home/marvincoelho/projects/codhous/resources/views/livewire/calculator.blade.php ENDPATH**/ ?>